...
/*objects are the concept of the object oriented programming. As objects can represent many entities in the program thus an entity like the
user will also perform actions and actions will be performed on it, so for this the objects has the methods. Eg the user may need access permision
thus accessPermission : function() { } will be a method for the object.
*/
...
// This is an example for understanding the use of the this keyword in the object and real world programming.
let user = {
    fname: 'shubham',
    lname: 'sonar',
...
console.log("user permissiom after changepermission function:",user.permision);
...
let user3 = {
    sayHi() { console.log(" Hello Programmer..! ") }
};
...
/*
!                    “this” is not bound
*   In JavaScript, keyword this behaves differently than most of the other programming languages. It can be used in any function,
 even if it’s not a method of an object.

*   Other programming language, use the "bound this", where methods defined in an object always have 'this' referencing ownself / own object. 
( Because the pure oop follows the concept of strict abstraction and encaptualation)

*   In JavaScript this is “free”, its value is evaluated at call-time / run-time and does not depend on where the method was declared, 
...
(Dad function and this Dad function takes it from its Dad object.)
...
let users = {
    ...
    sayHi() {
        ...
        let normalFunc = function () {
            ...
            console.log("Value of this insided the child normal function of sayHi()method: ", this.firstName);
         // The value of "this" is lost inside the nested normal function of the object method.
        };

        let arrow = () => console.log("Value of this insided the child arrow function of sayHi()method: ", this.firstName);
...
let users2 = {
    ...
    sayHi3() {
        const say = () => { console.log(this.firstName) }
        say();
    },

    // An example of this in the arrow function as the objct Method.
    sayHi4: () => { console.log(this) }
};

users2.sayHi();  // Shubham
users2.sayHi2(); // Shubham
users2.sayHi3(); // Shubham
