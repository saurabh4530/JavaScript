...
console.log(objNonPrim.array1[2]);
...
// We use brackets when we derive the name of the property through an expression or
// if we are accessing it using the variable that is holding the name of the object property.
// Thus we can write any expression in the brackets that gives us the name of the property.
...
for (let x in person) {
    ...
    console.log("property:",p,"has values:",v);// alternate way
}
...
properties have the same names as variables. The use-case of making a property from a variable is so common, 
