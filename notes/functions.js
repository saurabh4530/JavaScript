...
//Be it any (var, let, const), except the undeclared variable because it will have the global scope and thus created on global object 
//and accessible everywhere throughout the code through the scope chain. (In detail in Scope notes).
...
console.log(' These are the normal variables storing the returned array of multiple values  seperately : - ' 
+ firstNameArr + " " + lastNameArr);
...
console.log(' These are the Destructuring variables storing the returned array of multiple values seperately : - '
 + firstNameDeArr + " " + lastNameDeArr);
