...
// Change the second fruit in the nested array
combined[3][1] = 'Blueberry'; // Changing 'Strawberry' to 'Blueberry'
combined[0]="KIWI";
...
console.log(' The largest Number using the Spread on math.max' + Math.max(1, ...arr1, 2, ...arr2, 25)); // Output = 25
