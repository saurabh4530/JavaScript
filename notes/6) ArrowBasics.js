...
// ================================
// If the arrow function contains just one expression, you can omit the curly bracesand the `return` keyword. 
...
/*
Descriptive way of writing above arroew funciton
...
// Ex 1.
var arrowReturnObj = ()=> ( {name: "Shubham", lastname: "Sonar"} );
console.log(arrowReturnObj());

// Ex 2.
var arrowReturnObj = (first, last)=> ( {first, last} );
console.log(arrowReturnObj("Shubham","Sonar"));
