...
Time to Wind Down (Garbage Collection): At some point, it's time to wind down.
 Groups that no longer have a connection to you (unreachable objects) are akin to guests who are no longer part of the party—they can safely leave the hall (memory can be freed).
