...
7. indexOf(searchValue, fromIndex):
   - Returns the index of the first occurrence of a specified value in a string. Optionally, you can provide a fromIndex parameter to start the search from 
   a specific index.

8. lastIndexOf(searchValue, fromIndex):
   - Returns the index of the last occurrence of a specified value in a string. Optionally, you can provide a fromIndex parameter
    to start the search from a specific index.

9. localeCompare(compareString):
   - Compares two strings in the current locale and returns -1, 0, or 1, depending on whether the string comes before, is equal to, 
   or comes after the specified string.
...
1. indexOf(searchValue, fromIndex):
   - Returns the index of the first occurrence of a specified value in a string. Optionally, you can provide a fromIndex parameter 
   to start the search from a specific index.
...
let op3 = "Hello this is Shubham Sonar";
console.log(op3.substring(14, 10));
...
console.log(op10.padEnd(33, padStr));
console.log(op10);
...
console.log(op12.charAt(4));

// String charCodeAt(position)
let op13 = "I Love Coding";
console.log(op13.charCodeAt(4));
...
*/
let text1 = "Hello! My Name is Shubham Sonar and I am from Nashik";
...
// Input String
let str1 =
  "Different Frameworks of JS are React JS, Node JS, Express JS, Vue JS, etc";
...
console.log("\nAdditional Example:");
let str3 =
  "Names Starting with 'Sh' Shubham Shubhangi Shivam Shamal Shibam Shiv Shivendra Shammi Shailesh Shambhu Shankar Shivay Shyam Shekhar";
console.log(str3);
