...
const setNumbs = new Set([12, 21, 34, 66, 8, 8, 67, 88, 89, 39, 23,23,23,23]);
...
// console.log(setEmt2.get("Shubham")); // Returns undefined because no get method on sets.
// console.log(setEmt2["Shubham"]); // Returns undefined.
