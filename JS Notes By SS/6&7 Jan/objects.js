// Definition :- A javaScript object is an entity/data type having state(properties) and behavior (methods)....
...
let val = "property1";
console.log(objectName);  //{ property1: 'Value1', property2: 'value2', one: 1, truthyVal: true }
console.log(objectName.property1); // Value1
console.log(objectName["property1"]); // Value1
console.log(objectName[val]); // Value1   curley brackets ke niche hai val defined.
...
let objNonPrim = {
    ...
    array1 : [1,2,3,4,5],
    function1 : function (){   //***focus here bhai what he is saying??? */
...
console.log(person.fullName); // Expected Outputs:- Undefined if func() method never called , if called then Output: Shubham Sonar
...
console.log(person['cars']);
console.log(person['fullName']); // Expected Outputs:- Undefined but In Reality Output: Shubham Sonar
// person.func(); // To create the Property using the function
// console.log(person['fullName']);
...
// Actually during runtime the [fruit] property name is replaced with the actual string stored in the variable fruit. The brackets [] help the compiler understand that this is not the property name but its derived from the computed value.
