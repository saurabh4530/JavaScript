...
console.log("Example 4:", perfectResult);
...
console.log("Example 5:", correctedResult);
...
// type of infinity and NaN is a number...

var naren= Infinity;

console.log(typeof naren);
...
//console.log(isFinite(70)); working and comes true
...
console.log("\nparseInt():", Number.parseInt("42")); // 42
let binarySrt = "1021"
console.log(Number.parseInt(binarySrt,2));
// toExponential(x)
