...
// + will work as concatination if first operand is string.

// Example 1: Number to String
let num = 42;
let str = "The answer is: " + num; // Implicitly converts num to a string
console.log(str + 2 - 1 ); // Output: "The answer is: 42"     (- is purely numerical operand and it will not concatinate like + does )
...
console.log(bo1 + bo2); //(1+0)  (here it takes true=1 and false=0)

console.log(Boolean(''));
console.log(Boolean(" "));  // space comes true
...
console.log(typeof explicitStr,  typeof explicitNum,  typeof explicitBool); 
// Output: "123" 456 true
...
//Strctly numeric operrators will always try toconvert all the operands to Number dataype.
//+ wiil work as a concatination

// Example 1: Number to String
let numToString =" The answer is:"+ 42; // Implicitly converts number to a string   
console.log( typeof numToString); // Output: "The answer is: 42"


// Example 2: Boolean to String
let boolToString = "Value: " + true; // Implicitly converts boolean to a string
console.log( typeof boolToString); // Output: "Value: true"
