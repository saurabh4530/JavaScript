...
// String length()
let op1 = "ababababababababbabababab"; //starts from zero
console.log(op1.length);

// String slice(start, end)
let op2 = "Hello this is Shubham Sonar";
console.log(op2.slice(14,27)); //Output : Shubham Sonar and  it also start from zero...   starts from 14 but not including 27
...
console.log( str.slice(-3, -1) ); //  start from zero and not including -3

// String substr(start, length)

let op3 = "Hello this is Shubham Sonar";
console.log(op3.substring(10,14));
...
let op10 = " 1 people have name ";
let padStr = " xyz";
console.log(op10.padEnd(25, padStr));  //1 people have name  xyz  final lenth is here
console.log(op10.length);   
...
const myArray = text.split("#"); // u cna use any seperator #@$%^&*?|\/
...
console.log(str1.indexOf("JS", 60)); // Returns the index of the first occurrence
...
console.log("\nAdditional Example:");
let str3 = "Names Starting with 'Sh' Shubham Shubhangi Shivam Shamal Shibam Shiv Shivendra Shammi Shailesh Shambhu Shankar Shivay Shyam Shekhar";
console.log(str3);
let match = str3.match(/sha/g);  //why not returning
console.log(match);
//? Special characters
