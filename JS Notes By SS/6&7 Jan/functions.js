...
function multFn() {
    var mult = 9;
   globevar="i am availaible everywhere";
    return  function (val) {
        mult = mult * val;
        undeclared = mult;
        return mult;      
...
showMessage();
//console.log(message); This will show reference error as message not defined.  message is not defined
...
console.log(myName);  // Arjun will come as output  
