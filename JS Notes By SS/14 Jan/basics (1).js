...
const person = {
  ...
  /*
  Explanation:
  - The for...in loop is used to iterate over the ENUMBERABLE(able to be counted by one-to-one correspondence with the set of all positive integers.) properties of an object.
...
//! for of loop
  ...
  //? The value will hold the values from the array. It will change in every itteration.
  //? Internally the i will increment and the loop will stop once it reached to the lenth of an array
  //? Here numvers.length is the limit of the loop.


//* You can use the Break and Continue in the for of loop also
//const numbers = [11, 12, 13, 14, 15];
  for (let value of numbers) {
