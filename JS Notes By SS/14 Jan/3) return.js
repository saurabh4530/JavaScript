...
function greet(name) {
  ...
  var message = greet("Shubham");
  console.log(message); //Sonarutputs: Hello, ShubSonar!
...
// let returnedFunction = greetMe("Shubham");
// console.log(returnedFunction);

// returnedFunction();    // Calling the returned function  1st Way

greetMe("Shubham")();  // Calling the returned function 2nd way..  easy way
...
console.log("My Name is :", namesArr[1], " ", namesArr[0]);
...
console.log('Narendra Rajendra Pawar Aman Gupta Is On the way ')