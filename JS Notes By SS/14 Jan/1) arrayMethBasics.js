...
console.log(typeof numbs.toString());
...
// Below Statement will convert array as a string but in one go.
// Means first the toString() will convert whole array then directly store the final result in the numbs variable.
numbs = numbs.toString();
console.log(typeof numbs);
console.log(numbs);
console.log('\n');

// Below stmt will print the string element indexed at 0.

console.log(numbs[0]);

// This stmt will print the string from index 4 till the length

console.log(numbs.substr(4, numbs.length - 1));
...
Syntax- 
arr.splice(startIndex, NumberOfElementsToRemove, newElement1, newElement2, newElementN)
*/
