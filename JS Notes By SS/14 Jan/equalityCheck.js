...
// Example 15:
let emptyArray1 = [] == 0; // true (empty array is coerced to 0)
...
// Shallow copy. deep copy  take the notes form soomewhere 

arr11 = [1,1];
console.log(arr11); // [1,1]

console.log(copyArr11); // []
// Above copied array will not  change because it has the referenced of the arr11 and not the  value pass by arr11
...
// Example 21:
let differentReferenceArray1 = (arr1 = [1, 2, 3]) == [1, 2, 3]; // true (coercion results in the same content)
