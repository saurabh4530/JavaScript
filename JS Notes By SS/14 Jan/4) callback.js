...
function outerFunction(outerParam) {
  ...
  function innerFunction(innerParam) {
    // Inner function code   
  } closer function has access to variables and parameters of its parent function( every nested function is a closure function)!!
...
function outerFunction2(outerParam) {
  // console.log('Outer Param:', outerParam); // Shubham
  function innerFunction2(innerParam) {
  let fullName = outerParam + " " + innerParam; // Shubham Sonar 
  return fullName;    
  }
   return innerFunction2('Sonar');
}
//console.log(outerFunction2('Shubham'));
let customerName = outerFunction2('Shubham'); // Undefined
