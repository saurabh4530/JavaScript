...
function showMessage2(attribute1, attri2) {
    ...
    console.log("I am attribute1 inside function NOT MODIFIED-- " + attribute1);

    attribute1 = "Attri1 inside function";
    console.log("I am attribute1 inside function MODIFIED-- " + attribute1);
    return attribute1;
}
